...
/* Q2:SALES BY SEGMENT AND REGION
...
/* Q6:ORDER FREQUENCY BY CUSTOMER SEGMENT
...
/* Q7:CUSTOMER RETENTION ANALYSIS
...
/* Q8:PROFIT MARGIN BY SUB-CATEGORY
...
/* Q9:CUSTOMER SEGMENTATION USING RFM ANALYSIS
...
/* Q10:BASKET ANALYSIS FOR PRODUCT BUNDLING
...
/* Q11:REVENUE IMPACT OF SHIPPING DELAYS
...
/* Q12:TOP 10 PRODUCTS BY SALES AND PROFIT
...
/* Q13:CUSTOMER PURCHASE FREQUENCY ANALYSIS
...
/* Q14:PRODUCT RETURN RATE ANALYSIS
...
/* Q15:PRODUCT LIFECYCLE ANALYSIS
...
/* Q16:CUSTOMER CHURN ANALYSIS BY SEGMENT AND REGION
...
/* Q17:GEOGRAPHICAL SALES DISTRIBUTION
-Write a query to visualize the geographical distribution of sales across countries, states, and cities */
...
/* Q19:IMPACT OF SHIPPING MODE ON SALES AND PROFIT
-Write a query to analyze how different shipping modes impact sales and profit.
-Visualize the performance of each shipping mode */
SELECT Ship_Mode, 
       SUM(Sales) AS Total_Sales, 
       SUM(Profit) AS Total_Profit
FROM Sales_Report
...
/* Q20:SALES AND PROFIT BY SHIP MODE AND REGION
-Write a query to compare sales and profit across different shipping modes and regions */
